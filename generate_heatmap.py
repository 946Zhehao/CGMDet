...
def get_params():
    params = {
        'weight': 'runs/train/fg/fg4.pt',
        'cfg': 'cfg/training/paper2/Fine_grained4.yaml',
        'device': 'cuda:0',
        'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM
        'layer': 'model.model[44]',
...
if __name__ == '__main__':
    ...
    model('inference/0000009_01339_d_0000005.jpg', 'runs/result/Fine_grained4/44')
    # 0000009_01339_d_0000005
    # 0000005_00509_d_0000002.jpg
    # 0000009_03907_d_0000012.jpg